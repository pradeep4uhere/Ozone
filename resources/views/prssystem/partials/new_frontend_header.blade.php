...
<div class="template-index" style="background-color: #FFF; width: 100%">
            ...
            <div id="header" data-section-id="header-top" data-section-type="header-section">
               <header class="site-header" role="banner">
                        ...
                        <div class="row">
                           <div class="col-xs-12 col-sm-12 col-md-6 left-nav">
                              <div id="ishiheaderblock">
                                 <span>ORDER ONLINE OR CALL US +(1800) 0000 1234</span>
                              </div>
                           </div>
                                       ...
                                       <div class="social-icon-inner">
                                          <div class="header-social">
                                             <ul class="list--inline site-footer__social-icons social-icons">
                                                <li class="facebook">
                                                   <a class="social-icons__link" href="https://smartshop-ishi.myshopify.com/" title="smartshop.ishi on Facebook" target="_blank">
                                                   <i class="fa fa-facebook" aria-hidden="true"></i>
                                                   <span class="icon__-text">Facebook</span>
                                                   </a>
                                                </li>
                                                <li class="twitter">
                                                   <a class="social-icons__link" href="https://smartshop-ishi.myshopify.com/" title="smartshop.ishi on Twitter" target="_blank">
                                                   <i class="fa fa-twitter" aria-hidden="true"></i>
                                                   <span class="icon__-text">Twitter</span>
                                                   </a>
                                                </li>
                                                <li class="pinterest">
                                                   <a class="social-icons__link" href="https://smartshop-ishi.myshopify.com/" title="smartshop.ishi on Pinterest" target="_blank">
                                                   <i class="fa fa-pinterest-p" aria-hidden="true"></i>
                                                   <span class="icon__-text">Pinterest</span>
                                                   </a>
                                                </li>
                                                <li class="instagram">
                                                   <a class="social-icons__link" href="https://smartshop-ishi.myshopify.com/" title="smartshop.ishi on Instagram" target="_blank">
                                                   <i class="fa fa-instagram" aria-hidden="true"></i>
                                                   <span class="icon__-text">Instagram</span>
                                                   </a>
                                                </li>
                                                <li class="youtube">
                                                   <a class="social-icons__link" href="https://smartshop-ishi.myshopify.com/" title="smartshop.ishi on YouTube" target="_blank">
                  ...
                  <div class="header-top site-header-inner">
                     <div class="page-width">
                        <div class="row">
                           <div class="header-logo-section header-top-left col-md-2">
                              <h1 class="h2 header__logo" itemscope="" itemtype="http://schema.org/Organization">
                                 <a href="https://smartshop-ishi.myshopify.com/" itemprop="url" class="header__logo-image">
                                 <img src="./smartshop.ishi_files/Logo_2_large.png" alt="smartshop.ishi" itemprop="logo">
                                 </a>
                              </h1>
                           </div>
                                    ...
                                    <div class="cart-title clearfix collapsed" data-target="#cart-container" data-toggle="collapse">
                                       <div class="site-header__cart expand-more">
                                          <div class="cart-img">
                                             ...
                                             <span class="cart-qty hidden-lg-up">0</span>
                                          </div>
                              ...
                              <div id="_desktop_user_info" class="user_info full-width hidden-lg-down">
                                 ...
                                 <div id="userinfo-container" class="userinfo-inner collapse">
                                    <ul class="header-bar__module header-bar__module--list">
                                       <li class="my-account">
                                          <a href="https://smartshop-ishi.myshopify.com/account">Account</a>
                                       </li>
                                       <li class="logout">
                                          <a href="https://smartshop-ishi.myshopify.com/account/logout" id="customer_logout_link">Log Out</a>
                                       </li>
                                       <li>
                                       </li>
                                       <li class="wishlist"><a href="https://smartshop-ishi.myshopify.com/pages/wishlist">Wishlist
                                          </a>
                                       </li>
                                    </ul>
                                 </div>
