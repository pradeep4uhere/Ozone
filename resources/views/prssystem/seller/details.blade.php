            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="{{config('global.SELLER_IMG_GALLERY').DIRECTORY_SEPARATOR.'seller_'.$imgObj->seller_id.DIRECTORY_SEPARATOR.$imgObj->image_name}}" class="grid image-link">
                        <img style="height:290px;width:100%" src="{{config('global.SELLER_IMG_GALLERY').DIRECTORY_SEPARATOR.'seller_'.$imgObj->seller_id.DIRECTORY_SEPARATOR.$imgObj->image_name}}" class="img-fluid" alt="#">
                    </a>
                </div>
				<?php }}else{ ?>
                <div class="swiper-slide">
