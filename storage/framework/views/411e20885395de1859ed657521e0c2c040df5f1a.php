                        ...
                        <a href="<?php echo e(route('details',['slug'=>str_slug($prodObj['Product']['title']),'id'=>encrypt($prodObj['UserProduct']['id'])])); ?>">
                            ...
                            <div class="featured-title-box">
                                ...
                                <div class="bottom-icons">
                                    <div class="closed-now"><a href="javascript:void(0)" onClick="addToCart('<?php echo e(encrypt($prodObj['UserProduct']['id'])); ?>','<?php echo e(str_slug($prodObj['Product']['title'])); ?>')" class="btn" style="background-color:#ff3a6d;color:#FFF; ">Add To Cart</a></div>
