...
<html lang="<?php echo e(app()->getLocale()); ?>" >
    <head>
        ...
        <!--<link rel="stylesheet" href="<?php echo e(config('global.THEME_URL_CSS').'/materialize.min.css'); ?>">-->
        <link rel='stylesheet' href='https://fonts.googleapis.com/css?family=Pacifico'>
        <link rel='stylesheet' href='https://fonts.googleapis.com/icon?family=Material+Icons'>
        <link rel="stylesheet" href="<?php echo e(config('global.THEME_URL_CSS').'/login.css'); ?>">
        <style>
        .login-body{background-image:url(<?php echo e(config('global.THEME_URL_IMAGE').'/bg1.jpg'); ?>);background-size:cover;background-position: center;background-attachment:fixed;}
                        ...
                        <form class="form-horizontal" method="POST" action="<?php echo e(route('login')); ?>">
                            ...
                            <div class="row">
                                <div class="input-field">
                                    <input type="email" id="email" name="email" class="validate" required="required" placeholder="Email Address" value="<?php echo e(old('email')); ?>">
                                    <label for="user">
    ...
    <script  src="<?php echo e(config('global.THEME_URL_JS').'/jquery.min.js'); ?>"></script>
    <script  src="<?php echo e(config('global.THEME_URL_JS').'/materialize.min.js'); ?>"></script>
    <script  src="<?php echo e(config('global.THEME_URL_JS').'/login.js'); ?>"></script>
</body>
</html>
