...
<?php $__env->startSection('content'); ?>
		...
		<div class="switches">
			<div class="col-4">
				<div class="col-md-4 switch-right">
					<div class="switch-right-grid">
						<div class="switch-right-grid1">
							...
							<ul>
								<li>Sell: ₹14000</li>
								<li>Total Items Sold: 200 Items</li>
								<li>Total Order: 200</li>
							</ul>
						</div>
					</div>
					<div class="sparkline">
				...
				<div class="col-md-4 switch-right">
					...
					<div class="sparkline">
						<!--graph-->
						<link rel="stylesheet" href="<?php echo e(config('global.THEME_URL_CSS').'/profile/'); ?>graph.css">
						<script src="<?php echo e(config('global.THEME_URL_JS').'/profile/'); ?>jquery.flot.min.js"></script>
					<!--//graph-->
							<script>
				...
				<div class="activity_box">
					...
					<div class="scrollbar scrollbar1" id="style-2">
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='<?php echo e(config('global.THEME_URL_IMAGE').'/images/'); ?>1.png' class="img-responsive" alt=""/></div>
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='<?php echo e(config('global.THEME_URL_IMAGE').'/images/'); ?>5.png' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='<?php echo e(config('global.THEME_URL_IMAGE').'/images/'); ?>3.png' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='<?php echo e(config('global.THEME_URL_IMAGE').'/images/'); ?>4.png' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
				...
				<div class="activity_box activity_box1">
					...
					<div class="scrollbar" id="style-2">
						<div class="activity-row activity-row1">
							<div class="col-xs-3 activity-img"><img src='<?php echo e(config('global.THEME_URL_IMAGE').'/images/'); ?>1.png' class="img-responsive" alt=""/><span>10:00 PM</span></div>
						...
						<div class="activity-row activity-row1">
							...
							<div class="col-xs-3 activity-img"><img src='<?php echo e(config('global.THEME_URL_IMAGE').'/images/'); ?>3.png' class="img-responsive" alt=""/><span>10:02 PM</span></div>
							<div class="clearfix"> </div>
						</div>
						<div class="activity-row activity-row1">
							<div class="col-xs-3 activity-img"><img src='<?php echo e(config('global.THEME_URL_IMAGE').'/images/'); ?>1.png' class="img-responsive" alt=""/><span>10:00 PM</span></div>
        ...
        <!--footer section start-->
			<footer>
			   <p>&copy 2018 www.mydailyorder.com. All Rights Reserved</p>
			</footer>
        <!--footer section end-->
