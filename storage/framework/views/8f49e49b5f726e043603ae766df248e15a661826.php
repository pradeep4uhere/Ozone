				...
				<div class="graphs">
					<div class="col_3">
						<div class="col-md-2 widget widget1">
							<a href="<?php echo e(route('orderlist',['type'=>'All'])); ?>">
							<div class="r3_counter_box">
								<i class="fa fa-mail-forward"></i>
								<div class="stats">
								  <h5><?php echo e($allOrderType['order_recived']); ?></h5>
								  <div class="grow">
									<p>New Order</p>
								  </div>
								</div>
						...
						<div class="col-md-2 widget widget1">
							<a href="<?php echo e(route('orderlist',['type'=>'Processing'])); ?>">
							<div class="r3_counter_box">
								<i class="fa fa-mail-forward"></i>
								<div class="stats">
								  <h5><?php echo e($allOrderType['processing']); ?></h5>
								  <div class="grow">
									<p>Processing</p>
								  </div>
								</div>
						...
						<div class="col-md-2 widget widget1">
							<a href="<?php echo e(route('orderlist',['type'=>'Canceled'])); ?>">
							<div class="r3_counter_box">
								<i class="fa fa-users"></i>
								<div class="stats">
								  <h5><?php echo e($allOrderType['canceled']); ?></h5>
						...
						<div class="col-md-2 widget widget1">
							<a href="<?php echo e(route('orderlist',['type'=>'Complete'])); ?>">
							<div class="r3_counter_box">
								<i class="fa fa-eye"></i>

								<div class="stats">
								  <h5><?php echo e($allOrderType['delivered']); ?></h5>
		...
		<div class="switches">
			<div class="col-3">
				<div class="col-md-4 switch-right">
					<div class="switch-right-grid">
						<div class="switch-right-grid1">
							...
							<ul>
								<li>Sell: ₹<?php echo e($totalTodaySell); ?></li>
								<li>Total Items Sold: <?php echo e($totalTodayQuantity); ?> Items</li>
								<li>Total Order: <?php echo e($totalTodayOrder); ?></li>
							</ul>
						</div>
					</div>
					<div class="sparkline">
				...
				<div class="col-md-3 switch-right">
					<div class="switch-right-grid">
						<div class="switch-right-grid1">
							<h3> <b><?php echo e(strtoupper(date('F'))); ?></b> MONTH STATS</h3>
							<p>View All Month Stats Please , <a href="#">Click Here</a>.</p>
							<ul>
								<li>Total Order: <?php echo e($totalTodayOrder); ?></li>
								<li>Earning: ₹<?php echo e($totalMonthSell); ?></li>
								<li>Items Sold: <?php echo e($totalMonthQuantity); ?> Items</li>
							</ul>
						</div>
					</div>
					<div class="sparkline">
				...
				<div class="col-md-3 switch-right">
					<div class="switch-right-grid">
						<div class="switch-right-grid1">
							...
							<ul>
								<li>Total Order: <?php echo e($totalTodayOrder); ?></li>
								<li>Total Earning: ₹<?php echo e($totalAmount); ?></li>
								<li>Total Items Sold: <?php echo e($totalQuantity); ?> Items</li>
...
<h5>Complete your profile to start selling !</h5>
						...
						<div class="col-md-3 widget widget1">
							...
							<i class="fa fa-bank"></i><br/>
								...
								<hr style="margin-bottom:10px;">
								<div style="font-size:14px;text-align:center;padding-bottom:10px;">
								<a href="<?php echo e(route('seller')); ?>">Add Details</a>
								</div>
							</div>
						</div>
						...
						<div class="col-md-3 widget widget1">
							...
							<i class="fa fa-bank"></i><br/>
								...
								<hr style="margin-bottom:10px;">
								<div style="font-size:14px;text-align:center;padding-bottom:10px;">
								<a href="<?php echo e(route('selleraddproduct')); ?>">Add Details</a>
								</div>
							</div>
						</div>
