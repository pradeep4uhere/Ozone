						...
						<div class="details col-md-5 " style="margin:10px;">
							...
							<p class="price" style="font-size:20px; font-weight: bold;">current price: <span>MRP ₹ <?php echo e($productDetails['price']); ?></span><br/>
												<small  style="font-size:8px;">Inclusive of all Taxes</small>
													...
													<p style="font-size: 12px">Category :: <?php echo e($productDetails->product->Category['name']); ?> > <?php echo e($productDetails->product->SubCategory['name']); ?></p>
							<p class="vote" style="font-size: 12px"><strong>Unit:</strong> <?php echo e($productDetails['quantity_in_unit']); ?>&nbsp;<?php echo e($productDetails->product->Unit['name']); ?></p>
													<div class="action">
													...
													<br/>
													<div class="action">
								<a href="javascript:void(0)" class="btn" style="background-color:#ff3a6d;color:#FFF;" onClick="addToCart('<?php echo e(encrypt($productDetails->id)); ?>','<?php echo e(str_slug($productDetails->product['title'])); ?>')">Add To Cart</a>
															<a href="javascript:void(0)" onClick="buyNow('<?php echo e(encrypt($productDetails->id)); ?>','<?php echo e(str_slug($productDetails->product['title'])); ?>')" class="btn btn-success">Buy Now </a>
		...
		<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius quos aliquam consequuntur, esse provident impedit minima porro! Laudantium laboriosam culpa quis fugiat ea, architecto velit ab, deserunt rem quibusdam voluptatum.</p>
										...
										<div class="wrapper row">
											...
											<div class="featured-btn-wrap">
												<a href="javascript:void(0)" onClick="buyNow('<?php echo e(encrypt($productDetails->id)); ?>','<?php echo e(str_slug($productDetails->product['title'])); ?>')" class="btn btn-danger">Buy Now in <span>₹<?php echo e($productDetails['price']); ?></span></a>
